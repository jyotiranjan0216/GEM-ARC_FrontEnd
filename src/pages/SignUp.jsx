        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <button
              ...
              className="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-500 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-600 focus:ring-4 focus:ring-blue-300 transition-all shadow-md disabled:opacity-60 disabled:cursor-not-allowed"
            >
